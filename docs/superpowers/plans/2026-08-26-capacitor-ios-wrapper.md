...
- [ ] **Step 1: Install CocoaPods if missing**
...
- [ ] **Step 4: Build the web app so there's something to wrap**
...
- [ ] **Step 6: Verify Pods/build artifacts are excluded from git**
...
- [ ] **Step 2: Rebuild and re-sync so the native shell picks up the new value**
...
- [ ] **Step 3: Confirm there's nothing to commit**
...
- [ ] **Step 1: Add the Capacitor origin to backend CORS**
...
- [ ] **Step 2: Verify the backend still parses/imports cleanly**
...
- [ ] **Step 3: Add the local-networking ATS exception to Info.plist**
...
- [ ] **Step 4: Verify the plist is still valid XML**
...
- [ ] **Step 2: Pick and boot a Simulator**
...
- [ ] **Step 3: Build the app for that Simulator**
...
- [ ] **Step 4: Install and launch on the Simulator**
...
- [ ] **Step 5: Screenshot and visually confirm the app rendered**
...
- [ ] **Step 7: Confirm the existing web/PWA path is unaffected**
